...
### 1. Сборка проекта, находясь в корневой папке использовать команду
```bash
mvn clean package
```

### 2. Запуск приложения, выполните команду
```bash
java -jar target/url-shortener-project-1.0-SNAPSHOT.jar
```
