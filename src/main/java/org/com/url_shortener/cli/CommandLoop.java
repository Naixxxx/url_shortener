...
public final class CommandLoop {
    ...
    public CommandLoop(AppConfig config, UserService userService, LinkService linkService, CleanupService cleanupService) {
        this.config = config;
    ...
    public void run() {
        ...
        System.out.println("TTL (сек): " + config.ttlSeconds() + ", default maxClicks: " + config.defaultMaxClicks());
    ...
    private boolean handle(String line) throws Exception {
        ...
        switch (cmd) {
            ...
            case "create" -> {
                ...
                System.out.println("code=" + link.getCode() +
            ...
            case "list" -> {
                ...
                for (ShortLink l : links) {
                    ...
                    System.out.printf("%s | %s | clicks %d/%d | exp %s | %s%n",
                            l.getCode(),
                            status,
                            l.getClicksUsed(),
                            l.getMaxClicks(),
